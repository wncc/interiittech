...
this.prevMenu=a;this.scrollingDivs.menu_scroller.hideScrollbars();this.scrollingDivs.menu_scroller.scrollToTop()}},setTitle:function(a){"defaultHeader"===this._currentHeaderID&&c.query("#header header:not(.ignore)  #pageTitle").html(a)},setBackButtonText:function(a){"defaultHeader"===this._currentHeaderID&&(this.trimBackButtonText&&(a=a.substring(0,0)+""),0<this.backButtonText.length?c.query("#header header:not(.ignore) #backButton").html():c.query("#header header:not(.ignore)  #backButton").html(a))},
